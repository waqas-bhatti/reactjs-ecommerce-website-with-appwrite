...
export class StorageServices {
  ...
  // async fetchDocument(collectionId, documentId) {
  //   try {
  //     // Log the documentId to verify it's correct
  ...
  //     // Fetch the document from the Appwrite database
  ...
  //     return response; // Return the fetched document data
  //   } catch (error) {
